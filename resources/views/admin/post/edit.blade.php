...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Изменение постов</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="col-12">
                <form action="{{ route('admin.post.update', $post->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-6">
                        ...
                        <div class="col-6">
                            <img src="{{ asset('storage/' . $post->main_image) }}" alt="" class="col-6 mb-3">
                        </div>
                    ...
                    <div class="form-group col-6">
                        ...
                        <div class="col-6">
                            <img src="{{ asset('storage/' . $post->preview_image) }}" alt="" class="col-6 mb-3">
                        </div>
                        <div class="input-group">
                            <div class="custom-file">
